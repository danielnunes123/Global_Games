...
export default function Carrousela() {
const [data, setData] = useState([]);
const carrousel = useRef(null);

useEffect(()=>{
    fetch('http://localhost:3000/static/shoess.json')
    ...
    {data.map((item)=>{
        ...
        return (
            ...
            <div >
              ...
              <button id='btnget' className='bg-[#683CCF] w-[65px] h-[29px] rounded-[15px]'>Get</button>
            </div>
            </div>
            </div>
        )
